...
type
  ...
  REFCLSID* = ptr IID
  REFFMTID* = ptr IID
  EXCEPTION_ROUTINE* = proc (ExceptionRecord: ptr EXCEPTION_RECORD,
      EstablisherFrame: PVOID, ContextRecord: ptr CONTEXT,
...
type
  ...
  PCLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE *
    = ptr CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE
  ...
  PCLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 *
    = ptr CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1
  ...
  PCLAIM_SECURITY_ATTRIBUTES_INFORMATION *
    = ptr CLAIM_SECURITY_ATTRIBUTES_INFORMATION
  ...
  PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_UNION1_STRUCT1 * {.pure.} = object
    ...
    ReservedFlags* {.bitsize: 30.}: DWORD
  PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY_UNION1 * {.pure,
      union.} = object
    Flags*: DWORD
  ...
  PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY_UNION1 * {.pure,
      union.} = object
    Flags*: DWORD
  ...
  PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_UNION1_STRUCT1 * {.pure.} = object
    ...
    ReservedFlags* {.bitsize: 31.}: DWORD
  PROCESS_MITIGATION_EXTENSION_POINT_DISABLE_POLICY_UNION1 * {.pure,
      union.} = object
    Flags*: DWORD
  ...
  PJOBOBJECT_BASIC_ACCOUNTING_INFORMATION *
    = ptr JOBOBJECT_BASIC_ACCOUNTING_INFORMATION
  ...
  PJOBOBJECT_EXTENDED_LIMIT_INFORMATION *
    = ptr JOBOBJECT_EXTENDED_LIMIT_INFORMATION
  ...
  PJOBOBJECT_LIMIT_VIOLATION_INFORMATION *
    = ptr JOBOBJECT_LIMIT_VIOLATION_INFORMATION
  ...
  PJOBOBJECT_CPU_RATE_CONTROL_INFORMATION *
    = ptr JOBOBJECT_CPU_RATE_CONTROL_INFORMATION
  ...
  PSYSTEM_LOGICAL_PROCESSOR_INFORMATION *
    = ptr SYSTEM_LOGICAL_PROCESSOR_INFORMATION
...
type
  ...
  RTL_UMS_SCHEDULER_ENTRY_POINT* = proc (Reason: RTL_UMS_SCHEDULER_REASON,
      ActivationPayload: ULONG_PTR, SchedulerParam: PVOID): VOID {.stdcall.}
...
type
  ...
  PCASSEMBLY_FILE_DETAILED_INFORMATION *
    = ptr ASSEMBLY_FILE_DETAILED_INFORMATION
  ...
  RTL_VERIFIER_DLL_LOAD_CALLBACK* = proc (DllName: PWSTR, DllBase: PVOID,
      DllSize: SIZE_T, Reserved: PVOID): VOID {.stdcall.}
  RTL_VERIFIER_DLL_UNLOAD_CALLBACK* = proc (DllName: PWSTR, DllBase: PVOID,
      DllSize: SIZE_T, Reserved: PVOID): VOID {.stdcall.}
  RTL_VERIFIER_NTDLLHEAPFREE_CALLBACK* = proc (AllocationBase: PVOID,
      AllocationSize: SIZE_T): VOID {.stdcall.}
...
type
  ...
  PTP_CLEANUP_GROUP_CANCEL_CALLBACK* = proc (ObjectContext: PVOID,
      CleanupContext: PVOID): VOID {.stdcall.}
  ACTIVATION_CONTEXT* {.pure.} = object
  PTP_SIMPLE_CALLBACK* = proc (Instance: PTP_CALLBACK_INSTANCE,
      Context: PVOID): VOID {.stdcall.}
...
type
  ...
  PTRANSACTIONMANAGER_BASIC_INFORMATION *
    = ptr TRANSACTIONMANAGER_BASIC_INFORMATION
  ...
  PTRANSACTIONMANAGER_LOGPATH_INFORMATION *
    = ptr TRANSACTIONMANAGER_LOGPATH_INFORMATION
  ...
  PTRANSACTIONMANAGER_OLDEST_INFORMATION *
    = ptr TRANSACTIONMANAGER_OLDEST_INFORMATION
  ...
  PTRANSACTION_ENLISTMENTS_INFORMATION *
    = ptr TRANSACTION_ENLISTMENTS_INFORMATION
  ...
  PRESOURCEMANAGER_COMPLETION_INFORMATION *
    = ptr RESOURCEMANAGER_COMPLETION_INFORMATION
...
type
  ...
  PRTL_HEAP_COMMIT_ROUTINE* = proc (Base: PVOID, CommitAddress: ptr PVOID,
      CommitSize: PSIZE_T): NTSTATUS {.stdcall.}
...
const
  ...
  STATUS_THREADPOOL_RELEASE_SEMAPHORE_ON_COMPLETION_FAILED *
    = NTSTATUS 0xC000070C'i32
  STATUS_THREADPOOL_RELEASE_MUTEX_ON_COMPLETION_FAILED *
    = NTSTATUS 0xC000070D'i32
  STATUS_THREADPOOL_FREE_LIBRARY_ON_COMPLETION_FAILED *
    = NTSTATUS 0xC000070E'i32
...
const
  ...
  SE_PRIVILEGE_VALID_ATTRIBUTES* = SE_PRIVILEGE_ENABLED_BY_DEFAULT or
      SE_PRIVILEGE_ENABLED or SE_PRIVILEGE_REMOVED or SE_PRIVILEGE_USED_FOR_ACCESS
  ...
  CLAIM_SECURITY_ATTRIBUTE_VALID_FLAGS *
    = CLAIM_SECURITY_ATTRIBUTE_NON_INHERITABLE or
      ...
      CLAIM_SECURITY_ATTRIBUTE_DISABLED_BY_DEFAULT or
...
const
  ...
  RTL_CRITICAL_SECTION_FLAG_RESERVED* = RTL_CRITICAL_SECTION_ALL_FLAG_BITS and (
      not (RTL_CRITICAL_SECTION_FLAG_NO_DEBUG_INFO or
      RTL_CRITICAL_SECTION_FLAG_DYNAMIC_SPIN or
      RTL_CRITICAL_SECTION_FLAG_STATIC_INIT or
      RTL_CRITICAL_SECTION_FLAG_RESOURCE_TYPE or
  ...
  CM_SERVICE_VALID_PROMOTION_MASK* = CM_SERVICE_NETWORK_BOOT_LOAD or
      CM_SERVICE_VIRTUAL_DISK_BOOT_LOAD or CM_SERVICE_USB_DISK_BOOT_LOAD or
      CM_SERVICE_SD_DISK_BOOT_LOAD or CM_SERVICE_USB3_DISK_BOOT_LOAD or
      CM_SERVICE_MEASURED_BOOT_LOAD or CM_SERVICE_VERIFIER_BOOT_LOAD or CM_SERVICE_WINPE_BOOT_LOAD
  TAPE_ERASE_SHORT* = 0
  TAPE_ERASE_LONG* = 1
  TAPE_LOAD* = 0
  TAPE_UNLOAD* = 1
  ...
  TRANSACTIONMANAGER_GENERIC_WRITE* = STANDARD_RIGHTS_WRITE or
      TRANSACTIONMANAGER_SET_INFORMATION or TRANSACTIONMANAGER_RECOVER or
      TRANSACTIONMANAGER_RENAME or TRANSACTIONMANAGER_CREATE_RM
  TRANSACTIONMANAGER_GENERIC_EXECUTE* = STANDARD_RIGHTS_EXECUTE
  TRANSACTIONMANAGER_ALL_ACCESS* = STANDARD_RIGHTS_REQUIRED or
      TRANSACTIONMANAGER_GENERIC_READ or TRANSACTIONMANAGER_GENERIC_WRITE or
      TRANSACTIONMANAGER_GENERIC_EXECUTE or TRANSACTIONMANAGER_BIND_TRANSACTION
  ...
  TRANSACTION_GENERIC_READ* = STANDARD_RIGHTS_READ or
      TRANSACTION_QUERY_INFORMATION or SYNCHRONIZE
  TRANSACTION_GENERIC_WRITE* = STANDARD_RIGHTS_WRITE or
      TRANSACTION_SET_INFORMATION or TRANSACTION_COMMIT or TRANSACTION_ENLIST or
      TRANSACTION_ROLLBACK or TRANSACTION_PROPAGATE or SYNCHRONIZE
  TRANSACTION_GENERIC_EXECUTE* = STANDARD_RIGHTS_EXECUTE or
      TRANSACTION_COMMIT or TRANSACTION_ROLLBACK or SYNCHRONIZE
  TRANSACTION_ALL_ACCESS* = STANDARD_RIGHTS_REQUIRED or
      TRANSACTION_GENERIC_READ or TRANSACTION_GENERIC_WRITE or TRANSACTION_GENERIC_EXECUTE
  TRANSACTION_RESOURCE_MANAGER_RIGHTS* = TRANSACTION_GENERIC_READ or
      STANDARD_RIGHTS_WRITE or TRANSACTION_SET_INFORMATION or
  ...
  RESOURCEMANAGER_GENERIC_READ* = STANDARD_RIGHTS_READ or
      RESOURCEMANAGER_QUERY_INFORMATION or SYNCHRONIZE
  RESOURCEMANAGER_GENERIC_WRITE* = STANDARD_RIGHTS_WRITE or
      RESOURCEMANAGER_SET_INFORMATION or RESOURCEMANAGER_RECOVER or
      RESOURCEMANAGER_ENLIST or RESOURCEMANAGER_GET_NOTIFICATION or
      RESOURCEMANAGER_REGISTER_PROTOCOL or
      RESOURCEMANAGER_COMPLETE_PROPAGATION or SYNCHRONIZE
  RESOURCEMANAGER_GENERIC_EXECUTE* = STANDARD_RIGHTS_EXECUTE or
      RESOURCEMANAGER_RECOVER or RESOURCEMANAGER_ENLIST or
      RESOURCEMANAGER_GET_NOTIFICATION or
      RESOURCEMANAGER_COMPLETE_PROPAGATION or SYNCHRONIZE
  RESOURCEMANAGER_ALL_ACCESS* = STANDARD_RIGHTS_REQUIRED or
      RESOURCEMANAGER_GENERIC_READ or RESOURCEMANAGER_GENERIC_WRITE or RESOURCEMANAGER_GENERIC_EXECUTE
  ...
  ENLISTMENT_GENERIC_WRITE* = STANDARD_RIGHTS_WRITE or
      ENLISTMENT_SET_INFORMATION or ENLISTMENT_RECOVER or
      ENLISTMENT_SUBORDINATE_RIGHTS or ENLISTMENT_SUPERIOR_RIGHTS
  ENLISTMENT_GENERIC_EXECUTE* = STANDARD_RIGHTS_EXECUTE or ENLISTMENT_RECOVER or
      ENLISTMENT_SUBORDINATE_RIGHTS or ENLISTMENT_SUPERIOR_RIGHTS
  ENLISTMENT_ALL_ACCESS* = STANDARD_RIGHTS_REQUIRED or
      ENLISTMENT_GENERIC_READ or ENLISTMENT_GENERIC_WRITE or ENLISTMENT_GENERIC_EXECUTE
  ...
  WOW64_CONTEXT_ALL* = WOW64_CONTEXT_CONTROL or WOW64_CONTEXT_INTEGER or
      WOW64_CONTEXT_SEGMENTS or WOW64_CONTEXT_FLOATING_POINT or
      WOW64_CONTEXT_DEBUG_REGISTERS or WOW64_CONTEXT_EXTENDED_REGISTERS
  ...
  TRANSACTIONMANAGER_OBJECT_NAME_LENGTH_IN_BYTES * = (len(
      TRANSACTIONMANAGER_OBJECT_PATH)+1)+(38*sizeof(WCHAR))
  TRANSACTION_OBJECT_NAME_LENGTH_IN_BYTES * = (len(TRANSACTION_OBJECT_PATH)+1)+(
      38*sizeof(WCHAR))
  ENLISTMENT_OBJECT_NAME_LENGTH_IN_BYTES * = (len(ENLISTMENT_OBJECT_PATH)+1)+(
      38*sizeof(WCHAR))
  RESOURCE_MANAGER_OBJECT_NAME_LENGTH_IN_BYTES * = (len(
      RESOURCE_MANAGER_OBJECT_PATH)+1)+(38*sizeof(WCHAR))
